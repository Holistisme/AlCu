...
/*   Updated: 2026/01/21 12:34:41 by aheitz           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
inline void	ft_run(t_vector *tab, const int max) {
...
inline int	ft_ai_move(t_vector *tab)
{
  ...
  if (tab->index == 2)
  {
    ...
    if (next_line_value > 5 && (next_line_value - 5) % 4 != 0)
    {
      ...
      else if (current_value == 5 || current_value == 1) // Loosing position
        matches = 1;
      else
  ...
  else if (tab->index == 1)
  {
    ...
    {
      if (current_value == 5 || current_value == 1) // Loosing position
        matches = 1;
      else
        matches = current_value - 1;
    }
